...
model = load_model(r'C:\Users\ROG STRIX\Documents\000000000000000 MESIN\Tugas6_A_11800\model_mobilenet.h5')
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1800")  # 4 digit npm terakhir
